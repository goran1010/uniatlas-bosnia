...
function ResultGroup({
  ...
  return (
    <div className="relative mt-2 border border-(--border-color)/30 rounded-xl p-3 pt-4 bg-(--surface-1)/40">
      <span className="absolute -top-2.5 left-3 px-2 py-0.5 text-[0.7rem] font-semibold uppercase tracking-wide rounded bg-blue-50 text-(--accent) leading-tight dark:bg-blue-950">
        {label}
      </span>
